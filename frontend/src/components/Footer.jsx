      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap items-center md:justify-between justify-center">
          <div className="w-full md:w-4/12 px-4 mx-auto text-center">
            <div className="flex justify-center text-sm text-blueGray-500 font-semibold py-1">
            <p>  Copyright © 2022 -Developed by <a className='text-[#e54926]' href="https://kevinocampo.vercel.app/"> Kev</a>.</p>
            </div>
          </div>
        </div>
      </div>
